...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { code: @home.code, logo: @home.logo, name: @home.name, nickname: @home.nickname } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { code: @home.code, logo: @home.logo, name: @home.name, nickname: @home.nickname } }
